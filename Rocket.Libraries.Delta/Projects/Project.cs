...
namespace Rocket.Libraries.Delta.Projects
{
    ...
    public class Project
    {
        ...
        /// <summary>
        /// Gets or sets a list of commands to be run to perform the build. These are run
        /// synchronously and processing will stop if any one of the commands returns a non zero
        /// result. Commands are ran in the order in which they are entered
        /// </summary>
        ...
        /// <summary>
        /// Get's or sets a value that indicates whether the source should be kept after a
        /// successful build, or whether it should be deleted. This value is indicative, and if a
        /// remote repository is not configured on the project definition, then source will always
        /// be kept.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the optional set of commands to be run after a failing build. These
        /// commands are run after all other stages have been completed. They are run synchronously
        /// and processing will stop if any one of the commands returns a non zero result.
        /// </summary>
        public ImmutableList<BuildCommand> OnFailurePostBuildCommands { get; set; }

        /// <summary>
        /// Gets or sets the optional set of commands to be run after a successful build. These
        /// commands are run after all other stages have been completed. They are run synchronously
        /// and processing will stop if any one of the commands returns a non zero result.
        /// </summary>
